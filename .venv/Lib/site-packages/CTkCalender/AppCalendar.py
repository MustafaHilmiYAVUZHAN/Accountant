...
import calendar
from customtkinter import  CTkFrame, CTkLabel, CTkButton, CTkFont,set_default_color_theme,CTkToplevel
from hPyT import *
...
class CalendarApp(new_toplevel):
    def __init__(self,position : str = None, all_hide : Optional[Union[Literal["frame"],bool]] = None, topmost : bool = False, print : bool = False, command: Optional[Callable] = None, current_day_color : str="#1050d0", current_day_color_hover : str="#0c2f60",day_color : str="#090909", day_color_hover : str="#333333"):
    ...
    def day_click(self, day):
        ...
        self.selection = {"Day": day, "Month": self.current_month, "Year": self.current_year}
        if self.command is not None:
            self.command(self.selection)
        if self.all_hide is None:
            self.destroy()
        elif self.all_hide==True:
            self.destroy()
