...
class CTkScrollableDropdown(customtkinter.CTkToplevel):
    ...
    def __init__(self, attach, x=None, y=None, button_color=None, height: int = 200, width: int = None,
                 ...
                 command=None, image_values=[], alpha: float = 0.97, frame_corner_radius=0, double_click=False,
        ...
        self.frame = customtkinter.CTkScrollableFrame(self, bg_color="#010101", fg_color="#010101",
