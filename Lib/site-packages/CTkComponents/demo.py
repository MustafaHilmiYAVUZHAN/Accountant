...
def ctk_popup():
    ...
    popup_menu = CTkPopupMenu(master=preview_frame, width=250, height=200, title="Title", corner_radius=8, border_width=0)
    ...
    btn2 = ctk.CTkButton(popup_menu.frame, text="Option 2",height=10, command=lambda: print("Hello"), **BTN_OPTION)
    btn2.pack( padx=10, pady=0)

    btn3 = ctk.CTkButton(popup_menu.frame, text="Option 3", command=lambda: print("Hello"), **BTN_OPTION)
    btn3.pack(expand=True, fill="x", padx=10, pady=0)

    btn4 = ctk.CTkButton(popup_menu.frame, text="Option 4", command=lambda: print("Hello"), **BTN_OPTION)
    btn4.pack(expand=True, fill="x", padx=10, pady=0)

    btn5 = ctk.CTkButton(popup_menu.frame, text="Option 5", command=lambda: print("Hello"), **BTN_OPTION)
    btn5.pack(expand=True, fill="x", padx=10, pady=0)

def ctk_right_click_menu():
    label1 = ctk.CTkLabel(preview_frame, text="Right click to open Popup Menu!", font=("", 18))
    # label1.grid(padx=20, pady=20, sticky="nsew")
    label1.pack()
    right_click_menu=CTkRightClickMenu(master=preview_frame, width=250, height=None, corner_radius=8, border_width=0)
    right_click_menu.add_button(text="deneme0")
    right_click_menu.add_button(text="deneme1")
    right_click_menu.add_button(text="deneme2")
    right_click_menu.add_button(text="deneme3")
...
WIDGETS = {"CTkAlert": alert,
           ...
           "CTKRightClickMenu":ctk_right_click_menu}
...
if __name__ == "__main__":
    ...
    options = ["CTkAlert", "CTkBanner", "CTkNotification", "CTkCard",
               ...
               "CTkPopupMenu", "CTkProgressPopup", "CTkTreeview","CTKRightClickMenu"]
