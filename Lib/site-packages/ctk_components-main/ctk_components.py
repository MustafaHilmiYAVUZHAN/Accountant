...
class CTkRightClickMenu(ctk.CTkToplevel):
    def __init__(self,
                 master=None,
                 width=250,
                 height=None,
    ...
    def popup(self, x=None, y=None):
        ...
        self.geometry('{}x{}+{}+{}'.format(self.width, self.height, self.x, self.y))
        self.hidden = False
    def add_button(self,text : str = "button",height=25,fg_color="transparent", *args,**kwargs):
        self.buttons.append(ctk.CTkButton(self.frame,text=text,height=height,fg_color=fg_color,*args,**kwargs))
        self.buttons[-1].pack(expand=True, fill="x")
        self.height+=height
        self.geometry('{}x{}+{}+{}'.format(self.width, self.height, self.x, self.y))
